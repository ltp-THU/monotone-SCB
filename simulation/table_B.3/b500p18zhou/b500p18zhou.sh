...
dimension=18                        # Dimension
candidate="20:100"                   # Candidate vector (in R format)
...
Rscript ../simulation_tableB2.R $index $model $sample_size $dimension "$candidate" "$bandwidth" $simulation
