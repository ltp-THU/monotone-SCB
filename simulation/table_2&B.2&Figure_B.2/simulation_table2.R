...
library(MASS)
library(mlrv)
# args containing parameters: 1. index for batch (1-10) 2. model ("a" or "b") 3. sample size 4. dimension 5. candidate 6. bandwidths 7. GCV or not 8. simulation per batch
