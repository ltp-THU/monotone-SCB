...
echo "Penalization: $penalization"  # Print the penalization C1

Rscript ../penalization.R $index $model $sample_size $dimension "$candidate" "$bandwidth" "$GCV" $simulation $penalization
